...
def check_confidence(obstacle):
    global confidence_matrix, confidence_threshold
...
if __name__ == '__main__':
    global obstacle_encountered, maneuver_dict, helped_by_human, helped_by_robot, confidence_matrix, waiting_for_help, at_obstacle, current_obstacle, velocity_publisher, myID, confidence_threshold
    myID = "A"
    #initialize globals
    at_obstacle = False
    ...
    velocity_publisher = rospy.Publisher('/r1/mobile_base/commands/velocity', Twist, queue_size=10)
